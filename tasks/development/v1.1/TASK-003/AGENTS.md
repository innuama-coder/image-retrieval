...
You are a senior implementation agent assigned to `TASK-003`: `Candidate and image quality with Qwen 3.5 VLM adapter`. Read the source refs, `tasks/development/v1.1/development-planning.json`, this task's `task.md`, and this fixture directory before changing files.
...
4. Task description and fixture under `tasks/development/v1.1/TASK-003/`.
...
- Stay within the allowed scope for `TASK-003`.
