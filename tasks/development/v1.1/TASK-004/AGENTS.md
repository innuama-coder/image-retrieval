...
You are a senior implementation agent assigned to `TASK-004`: `Artifact backed retrieval channels and fallback execution`. Read the source refs, `tasks/development/v1.1/development-planning.json`, this task's `task.md`, and this fixture directory before changing files.
...
4. Task description and fixture under `tasks/development/v1.1/TASK-004/`.
...
- Stay within the allowed scope for `TASK-004`.
